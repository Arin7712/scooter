      ...
      <div className="container">
        <div className="md:mx-auto flex md:max-w-screen-xl flex-col justify-between gap-10 lg:flex-row lg:gap-20">
          ...
          >
            ...
            <motion.div className="grid w-full items-center gap-1.5" {...fadeIn(0.7, isInView)}>
              <Label htmlFor="email">Email</Label>
              <Input type="email" id="email" placeholder="Email" />
            </motion.div>
            <motion.div className="grid w-full items-center gap-1.5" {...fadeIn(0.8, isInView)}>
              <Label htmlFor="subject">Subject</Label>
              <Input type="text" id="subject" placeholder="Subject" />
            </motion.div>
            <motion.div className="grid w-full gap-1.5" {...fadeIn(0.9, isInView)}>
