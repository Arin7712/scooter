      ...
      <div className="flex items-center justify-between px-6 py-3 bg-gradient-to-b from-zinc-600 to-black rounded-full shadow-lg w-full max-w-3xl relative z-10">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {["Home", "Problem", "About", "Pricing"].map((item) => (
              <motion.div
                key={item}
              ...
              >
                <a href="#" className="text-sm text-neutral-300 hover:text-white  transition-all duration-200 ">
                  {item}
                </a>
              </motion.div>
            ))}
        ...
        >
          <a
            href="#"
            className="inline-flex items-center justify-center px-5 py-2 text-sm text-black bg-white rounded-full transition-colors"
          >
            Get Started
          </a>
        </motion.div>
